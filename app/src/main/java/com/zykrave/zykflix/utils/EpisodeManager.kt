...
import com.zykrave.zykflix.models.Video.Type.Episode
...
object EpisodeManager {
    ...
    fun convertToVideoTypeEpisodes(episodes: List<com.zykrave.zykflix.models.Episode>, database: AppDatabase, seasonNumber: Int): List<Episode> {
