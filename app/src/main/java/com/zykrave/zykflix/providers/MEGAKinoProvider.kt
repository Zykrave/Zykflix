...
object MEGAKinoProvider : Provider {
    ...
    override suspend fun getGenre(id: String, page: Int): Genre {
        ...
        return Genre(id, genreName, items.filterIsInstance<com.zykrave.zykflix.models.Show>())
    }
    ...
    override suspend fun getPeople(id: String, page: Int): People {
        ...
        val filmography = parseContentItems(document).filterIsInstance<com.zykrave.zykflix.models.Show>()
