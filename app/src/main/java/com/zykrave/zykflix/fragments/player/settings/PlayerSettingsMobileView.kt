...
import com.zykrave.zykflix.databinding.ItemSettingMobileBinding
import com.zykrave.zykflix.databinding.ViewPlayerSettingsMobileBinding
import com.zykrave.zykflix.utils.dp
import com.zykrave.zykflix.utils.margin
                ...
                setOnClickListener {
                    when (item) {
                        ...
                        is Settings.Gestures -> {
                            when (item) {
                                is Settings.Gestures.On -> com.zykrave.zykflix.utils.UserPreferences.playerGestures = true
                                is Settings.Gestures.Off -> com.zykrave.zykflix.utils.UserPreferences.playerGestures = false
                            }
                            settingsView.displaySettings(Setting.MAIN)
                        }
                        ...
                        is Settings.KeepScreenOn -> {
                            when (item) {
                                is Settings.KeepScreenOn.On -> com.zykrave.zykflix.utils.UserPreferences.keepScreenOnWhenPaused = true
                                is Settings.KeepScreenOn.Off -> com.zykrave.zykflix.utils.UserPreferences.keepScreenOnWhenPaused = false
                            }
                            settingsView.displaySettings(Setting.MAIN)
                        }
