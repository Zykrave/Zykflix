package com.zykrave.zykflix.fragments.player.settings
...
import com.zykrave.zykflix.utils.OpenSubtitles
import com.zykrave.zykflix.utils.mediaServers
import com.zykrave.zykflix.utils.SubDL
import com.zykrave.zykflix.utils.SubtitleOffset
import com.zykrave.zykflix.utils.UserPreferences
import com.zykrave.zykflix.utils.dp
import com.zykrave.zykflix.utils.findClosest
import com.zykrave.zykflix.utils.getAlpha
import com.zykrave.zykflix.utils.getRgb
import com.zykrave.zykflix.utils.mediaServerId
import com.zykrave.zykflix.utils.setAlpha
import com.zykrave.zykflix.utils.setRgb
import com.zykrave.zykflix.utils.supportedTrackFormats
        ...
        sealed class Subtitle : Item {
            ...
            sealed class OpenSubtitles : Item {
                ...
                companion object : Settings.Subtitle() {
                    ...
                    fun init(openSubtitles: List<com.zykrave.zykflix.utils.OpenSubtitles.Subtitle>) {
                        list.clear()
                ...
                class Subtitle(
                    val openSubtitle: com.zykrave.zykflix.utils.OpenSubtitles.Subtitle
                ) : OpenSubtitles()
            }
            ...
            sealed class SubDLSubtitles : Item {
                ...
                companion object : Settings.Subtitle() {
                    ...
                    fun init(subDLSubtitles: List<com.zykrave.zykflix.utils.SubDL.Subtitle>) {
                        list.clear()
                ...
                class Subtitle(
                    val subDLSubtitle: com.zykrave.zykflix.utils.SubDL.Subtitle
                ) : SubDLSubtitles()
            }
        }
