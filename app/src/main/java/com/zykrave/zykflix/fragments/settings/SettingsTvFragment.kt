package com.zykrave.zykflix.fragments.settings
...
import com.zykrave.zykflix.activities.main.MainTvActivity
import com.zykrave.zykflix.backup.BackupRestoreManager
import com.zykrave.zykflix.backup.ProviderBackupContext
import com.zykrave.zykflix.database.AppDatabase
import com.zykrave.zykflix.database.dao.EpisodeDao
import com.zykrave.zykflix.database.dao.MovieDao
import com.zykrave.zykflix.database.dao.TvShowDao
import com.zykrave.zykflix.database.dao.SeasonDao
import com.zykrave.zykflix.providers.AnimeOnlineNinjaProvider
import com.zykrave.zykflix.providers.FrenchStreamProvider
...
import com.zykrave.zykflix.utils.WebSocketBypassTestHelper
...
class SettingsTvFragment : LeanbackPreferenceFragmentCompat() {
    ...
    private fun displaySettings() {
        ...
        findPreference<Preference>("p_settings_telegram")?.setOnPreferenceClickListener {
            try {
                val tgIntent = Intent(Intent.ACTION_VIEW, Uri.parse("tg://resolve?domain=Pixel_Purity"))
                startActivity(tgIntent)
            } catch (e: Exception) {
                Toast.makeText(requireContext(), "Telegram not found.", Toast.LENGTH_SHORT).show()
                val intent = Intent(Intent.ACTION_VIEW, Uri.parse("https://t.me/Pixel_Purity"))
